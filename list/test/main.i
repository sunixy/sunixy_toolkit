...
# 1 "../include/st_list.h" 1
# 10 "../include/st_list.h"
...
static st_list g_unit_test_list = {0, ((void *)0), ((void *)0)};
...
{
    st_list_node *tmp = ((void *)0);
    test_node_t *entry = ((void *)0);

    printf("list lenthg=%ld\n", list->ulLength);

    for (tmp = list->head; tmp != ((void *)0); tmp = tmp->next)
    {
        entry = ((tmp != ((void *)0)) ? BT_MEMBER_OF_IMPL(tmp, test_node_t, node) : ((void *)0));
    }
